...
export async function WhatsappButton() {
  ...
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className="fixed bottom-5 right-5 z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105D366]"
    >
      <svg
        viewBox="0 0 24 24"
        className="size-7"
